...
// only describe player 2 now, Zen vs Garnet
	String actionForwardPositiveCommentary[] = {
			...
			"He knew when to use",
			"He is pressing his opponent by using",
			"Hit her by",
			"For a chance, he used",
			"How skillfully, Zen used",
			"He released a powerful"
	...
	String actionBackwardPositiveCommentary[] = {
			...
			", really a good one",
			"that Garnet should be very careful",
			". That'll be a great deal",
			". Some damage here",
			"that should tell her to quit this game",
			". It's a good deal of damage",
			". That's a nice shot",
			". That's perfect",
			". She gotta be punished!",
			". Garnet will lose for sure!",
			". Nice!"
	...
	String healthBackwardQuestion[] = {
			", that he can rely on being pretty safe to hit",
			"to get him punished",
			", and knock her down"
	...
	String healthPositiveCommentary[] = {
			"Yeah, he successfully punished her!",
	...
	String healthNegativeCommentary[] = {
			"He is at a dangerous point",
			"He likes being in that range",	
			"Hoo, what a bad timing",
			"He could have been knocked down",
			"What is he doing!!",
			"That's a bad move",
			"Oh, no. Not that",
